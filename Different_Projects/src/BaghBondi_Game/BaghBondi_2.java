...
public class BaghBondi_2 implements ActionListener {
    ...
    boolean inGame = false,s=false,t=false,u=false,v=false;
    boolean win = false;
    ...
    public void showGame() {
        ...
        inGame=true;
        /*for(int i=0; i<13; i++) {
            System.out.println(i+" jjj "+btn[i].isEnabled());
        }*/
    }
    ...
    {
        new BaghBondi_2(); // Calling the class construtor.
    }    
}