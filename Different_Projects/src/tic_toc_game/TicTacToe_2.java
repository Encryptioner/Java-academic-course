...
public class TicTacToe_2 implements ActionListener {
...
public TicTacToe_2() { //Setting game properties and layout and sytle...
...
new TicTacToe_2();// Calling the cl*** construtor.
// PROGRAM STARTS HERE!
}
